        ...
        <div class="card-body">
            <form action="{{route('books.update', $book->id)}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" name="bookName" class="form-control w-50 @error('bookName') is-invalid @enderror" id="name" placeholder="Eg: Electronics" value="{{$book->name}}">
                  @error('bookName')
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="file" name="bookImage" class="form-control-file mb-3 w-50 @error('bookImage') is-invalid @enderror" id="image" placeholder="...">
                  <img src="{{asset($book->image)}}" alt="" width="200">
                  @error('bookImage')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <textarea name="bookDescription" rows="10" class="form-control w-50 @error('bookDescription') is-invalid @enderror" id="description">{{$book->description}}</textarea>
